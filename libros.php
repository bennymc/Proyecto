...
<!-- ******************** INICIA SECTION ************************** -->
	...
	<!-- ******************** GENERO 1 ************************** -->	
		<div class="panel panel-success">
  			<div class="panel-heading">
    			<a href="genero.php"><h3 class="TituloGrande">Genero 1</h3></a>
  			</div>
  			<div class="panel-body librosSeparados">
	...
	<!-- ******************** GENERO 2 ************************** -->		
		<div class="panel panel-success">
  			<div class="panel-heading">
    			<a href="genero.php"><h3 class="TituloGrande">Genero 2</h3> </a>
  			</div>
  			<div class="panel-body librosSeparados">
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
	...
	<!-- ******************** GENERO 3 ************************** -->		
		<div class="panel panel-success">
  			<div class="panel-heading">
    			<a href="genero.php"><h3 class="TituloGrande">Genero 3</h3></a>
  			</div>
  			<div class="panel-body librosSeparados">
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
	...
	<!-- ******************** GENERO 4 ************************** -->		
		<div class="panel panel-success">
  			<div class="panel-heading">
    			<a href="genero.php"><h3 class="TituloGrande">Genero 4</h3></a>
  			</div>
  			<div class="panel-body librosSeparados">
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
	...
	<!-- ******************** GENERO 5 ************************** -->		
		<div class="panel panel-success">
  			<div class="panel-heading">
    			<a href="genero.php"><h3 class="TituloGrande">Genero 5</h3></a>
  			</div>
  			<div class="panel-body librosSeparados">
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
				<a href="ejemplar.php"><img src="http://placehold.it/100x150" alt="Libro"></a>
